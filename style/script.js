...
const fullText1 = ["Chúc mừng sinh nhật", "Khánh Vy", "Chúc mày luôn vui vẻ, hạnh phúc", "Luôn luôn thuận lợi trong cuộc sống"];
const fullText2 = ["chúc mày sẽ có thêm nhiều sức khỏe", "để theo đuổi đam mê", "nhiều niềm tin để vượt qua thử thách" ];
const fullText3 = ["và chúc mày thật nhiều thành công", "trong mọi dự định trong tương lai"];
